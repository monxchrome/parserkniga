...
class AudioAudiobooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=1000, blank=True, null=True)
    book = models.ForeignKey('AudioBooks2', models.DO_NOTHING)
...
class AudioAuthors2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class AudioAuthorsLinks2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class AudioAuthorsToBooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    author = models.ForeignKey('AudioAuthors2', models.DO_NOTHING)
    book = models.ForeignKey('AudioBooks2', models.DO_NOTHING)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class AudioBookCommentLikes2(models.Model):
    audio_book_comment = models.ForeignKey('AudioBookComments2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class AudioBookComments2(models.Model):
    id = models.BigAutoField(primary_key=True)
    hidden = models.IntegerField()
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    audio_book = models.ForeignKey('AudioBooks2', models.DO_NOTHING)
...
class AudioBookGenre2(models.Model):
    audio_book = models.ForeignKey('AudioBooks2', models.DO_NOTHING)
    genre = models.ForeignKey('Genres2', models.DO_NOTHING)
...
class AudioBookReviewCommentLikes2(models.Model):
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class AudioBookReviewComments2(models.Model):
    id = models.BigAutoField(primary_key=True)
    hidden = models.IntegerField()
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    audio_book_review = models.ForeignKey('AudioBookReviews2', models.DO_NOTHING)
    content = models.TextField()
...
class AudioBookReviewLikes2(models.Model):
    audio_book_review = models.ForeignKey('AudioBookReviews2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class AudioBookReviews2(models.Model):
    id = models.BigAutoField(primary_key=True)
    active = models.IntegerField()
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    audio_book = models.ForeignKey('AudioBooks2', models.DO_NOTHING)
    review_type = models.ForeignKey('ReviewTypes2', models.DO_NOTHING)
...
class AudioBookUser2(models.Model):
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    audio_book = models.ForeignKey('AudioBooks2', models.DO_NOTHING)
...
class AudioBooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    ...
    series = models.ForeignKey('AudioSeries2', models.DO_NOTHING, blank=True, null=True)
    link = models.OneToOneField('AudioBooksLinks2', models.DO_NOTHING, blank=True, null=True)
    ...
    genre = models.ForeignKey('Genres2', models.DO_NOTHING, blank=True, null=True)
...
class AudioBooksLinks2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class AudioCategoryTabs2(models.Model):
    id = models.BigAutoField(primary_key=True)
    show = models.IntegerField()
    genre = models.OneToOneField('Genres2', models.DO_NOTHING)
...
class AudioGenres2(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(unique=True, max_length=300)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class AudioImages2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class AudioLetters2(models.Model):
    id = models.BigAutoField(primary_key=True)
    link = models.CharField(unique=True, max_length=300)
    doparse = models.IntegerField(db_column='doParse')  # Field name made lowercase.
    created_at = models.DateTimeField(blank=True, null=True)
...
class AudioParsingStatuses2(models.Model):
    id = models.BigAutoField(primary_key=True)
    site = models.ForeignKey('AudioSites2', models.DO_NOTHING)
...
class AudioReaders2(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(unique=True, max_length=300)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class AudioReadersToBooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    reader = models.ForeignKey(AudioReaders2, models.DO_NOTHING)
    book = models.ForeignKey(AudioBooks2, models.DO_NOTHING)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class AudioSeries2(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(unique=True, max_length=300)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class AudioSites2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class AuthorToBooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    author = models.ForeignKey('Authors2', models.DO_NOTHING)
    book = models.ForeignKey('Books2', models.DO_NOTHING)
...
class AuthorsToAudioBooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    author = models.ForeignKey(Authors2, models.DO_NOTHING)
    book = models.ForeignKey(AudioBooks2, models.DO_NOTHING)
    created_at = models.DateTimeField(blank=True, null=True)
...
class BannerGenre2(models.Model):
    banner = models.ForeignKey('Banners2', models.DO_NOTHING)
    genre = models.ForeignKey('Genres2', models.DO_NOTHING)
...
class BannerPageName2(models.Model):
    banner = models.ForeignKey('Banners2', models.DO_NOTHING)
    page_name = models.ForeignKey('PageNames2', models.DO_NOTHING)
...
class BannerSitePageName2(models.Model):
    banner = models.ForeignKey('Banners2', models.DO_NOTHING)
    site_page_name = models.ForeignKey('SitePageNames2', models.DO_NOTHING)
...
class BookAnchors2(models.Model):
    id = models.BigAutoField(primary_key=True)
    book = models.ForeignKey('Books2', models.DO_NOTHING)
...
class BookAnchorsLinks2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class BookBookGenre2(models.Model):
    book = models.ForeignKey('Books2', models.DO_NOTHING)
    book_genre = models.ForeignKey('BookGenres2', models.DO_NOTHING)
...
class BookCategoryTabs2(models.Model):
    id = models.BigAutoField(primary_key=True)
    show = models.IntegerField()
    genre = models.OneToOneField('Genres2', models.DO_NOTHING)
    order = models.IntegerField()
...
class BookCommentLikes2(models.Model):
    book_comment = models.ForeignKey('BookComments2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class BookComments2(models.Model):
    id = models.BigAutoField(primary_key=True)
    hidden = models.IntegerField()
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    book = models.ForeignKey('Books2', models.DO_NOTHING)
...
class BookCompilation2(models.Model):
    compilation = models.ForeignKey('Compilations2', models.DO_NOTHING)
...
class BookGenres2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class BookReviewCommentLikes2(models.Model):
    book_review_comment = models.ForeignKey('BookReviewComments2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class BookReviewComments2(models.Model):
    id = models.BigAutoField(primary_key=True)
    hidden = models.IntegerField()
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    book_review = models.ForeignKey('BookReviews2', models.DO_NOTHING)
    content = models.TextField()
    parent_comment = models.ForeignKey('self', models.DO_NOTHING, blank=True, null=True)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class BookReviewLikes2(models.Model):
    book_review = models.ForeignKey('BookReviews2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class BookReviews2(models.Model):
    id = models.BigAutoField(primary_key=True)
    active = models.IntegerField()
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    book = models.ForeignKey('Books2', models.DO_NOTHING)
...
class BookTranslator2(models.Model):
    book = models.ForeignKey('Books2', models.DO_NOTHING)
    translator = models.ForeignKey('Translators2', models.DO_NOTHING)
...
class Bookmarks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    book = models.ForeignKey('Books2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
    page = models.ForeignKey('Pages2', models.DO_NOTHING)
...
class Books2(models.Model):
    ...
    series = models.ForeignKey('Series2', models.DO_NOTHING, blank=True, null=True)
    year = models.ForeignKey('Years2', models.DO_NOTHING, blank=True, null=True)
...
class ClaimForms2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class CommentLikes2(models.Model):
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    comment = models.ForeignKey('Comments2', models.DO_NOTHING)
...
class CompilationType2(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=191)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class CompilationUser2(models.Model):
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    compilation = models.ForeignKey('Compilations2', models.DO_NOTHING)
...
class Compilations2(models.Model):
    id = models.BigAutoField(primary_key=True)
    title = models.CharField(max_length=100)
    background = models.CharField(max_length=255)
    description = models.CharField(max_length=10000)
    created_by = models.ForeignKey('Users2', models.DO_NOTHING, db_column='created_by')
    type = models.ForeignKey(CompilationType2, models.DO_NOTHING, blank=True, null=True)
...
class DefaultOrderSettings2(models.Model):
    id = models.BigAutoField(primary_key=True)
    page_name = models.ForeignKey('PageNames2', models.DO_NOTHING)
...
class DefaultReaderSettings2(models.Model):
...
class Duplicates2(models.Model):
    id = models.BigAutoField(primary_key=True)
    book = models.ForeignKey(Books2, models.DO_NOTHING, blank=True, null=True)
...
class FailedJobs2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class FeedbackFormAttachments2(models.Model):
    id = models.BigAutoField(primary_key=True)
    feedback_form = models.ForeignKey('FeedbackForms2', models.DO_NOTHING)
...
class FeedbackForms2(models.Model):
    id = models.BigAutoField(primary_key=True)
    name = models.CharField(max_length=191)
    email = models.CharField(max_length=191)
    subject = models.CharField(max_length=191)
...
class HeaderMenus2(models.Model):
    id = models.BigAutoField(primary_key=True)
    show = models.IntegerField()
    order = models.IntegerField()
...
class IdSocialNetworks2(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.OneToOneField('Users2', models.DO_NOTHING)
...
class Images2(models.Model):
    id = models.BigAutoField(primary_key=True)
    page = models.ForeignKey('Pages2', models.DO_NOTHING, blank=True, null=True)
    book = models.ForeignKey(Books2, models.DO_NOTHING, blank=True, null=True)
...
class Migrations2(models.Model):
...
class Modulables2(models.Model):
    module = models.ForeignKey('Modules2', models.DO_NOTHING)
...
class ModulePageName2(models.Model):
    module = models.ForeignKey('Modules2', models.DO_NOTHING)
    page_name = models.ForeignKey('PageNames2', models.DO_NOTHING)
...
class NotificationUser2(models.Model):
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    notification = models.ForeignKey('Notifications2', models.DO_NOTHING)
...
class OauthAccessTokens2(models.Model):
...
class OauthAuthCodes2(models.Model):
    id = models.CharField(primary_key=True, max_length=100)
...
class OauthClients2(models.Model):
    id = models.BigAutoField(primary_key=True)
    user_id = models.PositiveBigIntegerField(blank=True, null=True)
    name = models.CharField(max_length=191)
...
class OauthPersonalAccessClients2(models.Model):
    id = models.BigAutoField(primary_key=True)
    client_id = models.PositiveBigIntegerField()
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class OauthRefreshTokens2(models.Model):
    id = models.CharField(primary_key=True, max_length=100)
...
class ParsingStatus2(models.Model):
    id = models.BigAutoField(primary_key=True)
    site_id = models.IntegerField()
...
class PasswordResets2(models.Model):
    email = models.CharField(max_length=191)
...
class PublisherToBooks2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class Publishers2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class QuoteLikes2(models.Model):
    quote = models.ForeignKey('Quotes2', models.DO_NOTHING)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class Rates2(models.Model):
    id = models.BigAutoField(primary_key=True)
    book = models.ForeignKey(Books2, models.DO_NOTHING, blank=True, null=True)
    audio_book = models.ForeignKey(AudioBooks2, models.DO_NOTHING, blank=True, null=True)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class ReadingSettings2(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
...
class ReadingStatuses2(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey('Users2', models.DO_NOTHING)
    book = models.ForeignKey(Books2, models.DO_NOTHING)
...
class ReviewTypes2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class SidebarItems2(models.Model):
    id = models.BigAutoField(primary_key=True)
    show = models.IntegerField()
    genre = models.OneToOneField(Genres2, models.DO_NOTHING)
    order = models.IntegerField()
...
class SimilarAuthors2(models.Model):
...
class SitePageNames2(models.Model):
    id = models.BigAutoField(primary_key=True)
...
class TelescopeEntries2(models.Model):
...
class TelescopeEntriesTags2(models.Model):
    entry_uuid = models.ForeignKey(TelescopeEntries2, models.DO_NOTHING, db_column='entry_uuid')
...
class TelescopeMonitoring2(models.Model):
    tag = models.CharField(max_length=191)
...
class Translators2(models.Model):
...
class UserAuthor2(models.Model):
    author = models.ForeignKey(Authors2, models.DO_NOTHING)
    user = models.ForeignKey('Users', models.DO_NOTHING)
    created_at = models.DateTimeField(blank=True, null=True)
    updated_at = models.DateTimeField(blank=True, null=True)
...
class UserSettings2(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.OneToOneField('Users2', models.DO_NOTHING)
...
class UsersRecommended2(models.Model):
    id = models.BigAutoField(primary_key=True)
    book = models.ForeignKey(Books2, models.DO_NOTHING, blank=True, null=True)
    audio_book = models.ForeignKey(AudioBooks2, models.DO_NOTHING, blank=True, null=True)
...
class Views2(models.Model):
    user = models.ForeignKey(Users2, models.DO_NOTHING, blank=True, null=True)
